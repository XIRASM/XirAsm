...
const exports: list = macho_export_use64(
    macho_export_use64(macho_export_new(), "entry", "_entry"),
    "answer", "_answer")
const command_count: u64 = 5
const id_command_size: u64 = macho_align_up(macho_dylib_id_command_base_size + len("@rpath/libxirarmffi.dylib") + 1, 8)
...
macho_dylib_id64("@rpath/libxirarmffi.dylib", 0x00010000, 0x00010000);
