...
const page_size: u64 = macho_target_page_size64(macho_cpu_type_x86_64)
...
macho_import_emit_stubs_x86_64(imports, stubs_vaddr, slots_vaddr);
...
defer {
    ...
    assert(load.u32(macho_file + 8) == (macho_cpu_subtype_x86_64_all | macho_cpu_subtype_lib64));
