...
const command_size: u64 = macho_exe_pagezero_command_size + macho_exe_text_command_size + macho_segment_command64_size + dylinker_command_size + macho_exe_main_command_size + macho_exe_build_version_command_size
