...
arm64_ldr_reg(arm64_x0, arm64_x1, arm64_x2, false)
sug_ldr_reg:
arm64_asm("ldr x0, [x1, x2]")

dir_ldr_post:
arm64_ldr_post(arm64_x19, arm64_x1, 8)
sug_ldr_post:
arm64_asm("ldr x19, [x1], 8")

dir_ldr_pre:
arm64_ldr_pre(arm64_x0, arm64_x1, -8)
sug_ldr_pre:
arm64_asm("ldr x0, [x1, -8]!")

dir_ldur_neg:
arm64_ldur_imm(arm64_x0, arm64_x1, -8)
sug_ldur_neg:
arm64_asm("ldur x0, [x1, -8]")

dir_ldr_lit:
arm64_ldr_lit(arm64_x0, "lit")
sug_ldr_lit:
arm64_asm("ldr x0, lit")
