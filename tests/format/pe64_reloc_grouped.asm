...
relocs = pe_reloc_add_dir64_at(relocs, text_rva, abs_ptr0, text_start)
relocs = pe_reloc_add_dir64_at(relocs, text_rva, abs_ptr1, text_start)
relocs = pe_reloc_add_dir64_at(relocs, text_rva, abs_ptr2, text_start)
